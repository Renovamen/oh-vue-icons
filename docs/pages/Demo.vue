...
>
  ...
  <p class="mb-2 px-4 font-semibold">
    <a
    ...
    ·
    <a
      href="https://github.com/Renovamen/oh-vue-icons#readme"
      target="_blank"
      class="hover:underline"
      :class="{
        'text-blue-600': !isDark,
